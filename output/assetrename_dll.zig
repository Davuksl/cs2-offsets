...
pub const cs2_dumper = struct {
    pub const schemas = struct {
        ...
        // Class count: 380
        // Enum count: 35
        pub const assetrename_dll = struct {
            // Alignment: 4
            // Member count: 2
            ...
            // Alignment: 4
            // Member count: 2
            pub const SmartPropRadiusPlacementMode_t = enum(u32) {
                SPHERE = 0x0,
                CIRCLE = 0x1
            };
            // Alignment: 4
            // Member count: 4
            pub const SmartPropPlaceMeshOrientationMode_t = enum(u32) {
                FIRST_OPEN_EDGE = 0x0,
            ...
            // Alignment: 4
            // Member count: 5
            pub const SmartPropDeformableOrientMode_t = enum(u32) {
                NONE = 0x0,
                FORWARD_NORMAL = 0x1,
                UP_NORMAL = 0x2,
                BACKWARD_NORMAL = 0x3,
            ...
            // Alignment: 4
            // Member count: 7
            pub const Comparison_t = enum(u32) {
            ...
            // Alignment: 4
            // Member count: 4
            pub const ConfigurationHandleShape_t = enum(u32) {
                NONE = 0x0,
                SQUARE = 0x1,
                CIRCLE = 0x2,
                DIAMOND = 0x3
            ...
            // Alignment: 4
            // Member count: 3
            pub const SmartPropChoiceSelectionMode_t = enum(u32) {
                RANDOM = 0x0,
                FIRST = 0x1,
                SPECIFIC = 0x2
            };
            // Alignment: 4
            // Member count: 2
            pub const SmartPropDistributionMode_t = enum(u32) {
                RANDOM = 0x0,
                REGULAR = 0x1
            };
            // Alignment: 1
            // Member count: 2
            pub const ComparisonValueType = enum(u8) {
                COMPARISONVALUETYPE_FIXEDVALUE = 0x0,
                COMPARISONVALUETYPE_PARAMETER = 0x1
            };
            // Alignment: 4
            // Member count: 2
            pub const DampedValueType = enum(u32) {
                FloatParameter = 0x0,
                VectorParameter = 0x1
            };
            // Alignment: 4
            // Member count: 5
            pub const StateValue = enum(u32) {
            ...
            // Alignment: 4
            // Member count: 3
            pub const SmartPropDirection_t = enum(u32) {
                FORWARD = 0x0,
                LEFT = 0x1,
                UP = 0x2
            };
            // Alignment: 4
            // Member count: 4
            pub const SmartPropPathPositions_t = enum(u32) {
                ALL = 0x0,
                NTH = 0x1,
                START_AND_END = 0x2,
                CONTROL_POINTS = 0x3
            ...
            // Alignment: 4
            // Member count: 3
            pub const SmartPropDeformableAttachMode_t = enum(u32) {
                RELATIVE = 0x0,
                SNAP = 0x1,
                STIFFEN = 0x2
            };
            // Alignment: 4
            // Member count: 3
            pub const AnimConflictType_t = enum(u32) {
                NONE = 0x0,
                ID = 0x1,
                NAME = 0x2
            };
            // Alignment: 4
            // Member count: 3
            pub const StateComparisonValueType = enum(u32) {
            ...
            // Alignment: 4
            // Member count: 6
            pub const SmartPropDetailFadeLevel_t = enum(u32) {
                NONE = 0x0,
                MOST_AGGRESSIVE = 0x1,
                MORE_AGGRESSIVE = 0x2,
                NORMAL = 0x3,
            ...
            // Alignment: 4
            // Member count: 3
            pub const SmartPropSpace_t = enum(u32) {
                WORLD = 0x0,
                OBJECT = 0x1,
                ELEMENT = 0x2
            };
            // Alignment: 4
            // Member count: 3
            pub const ApplyColorMode_t = enum(u32) {
                MULTIPLY_OBJECT = 0x0,
            ...
            // Alignment: 4
            // Member count: 2
            pub const SolveIKChainAnimNodeSettingSource = enum(u32) {
                SOLVEIKCHAINANIMNODESETTINGSOURCE_Default = 0x0,
                SOLVEIKCHAINANIMNODESETTINGSOURCE_Override = 0x1
            };
            // Alignment: 4
            // Member count: 2
            pub const SmartPropGridOriginBasis_t = enum(u32) {
                CENTER = 0x0,
                CORNER = 0x1
            };
            // Alignment: 4
            // Member count: 2
            pub const EAnimValueSource = enum(u32) {
                Constant = 0x0,
                Parameter = 0x1
            };
            // Alignment: 4
            // Member count: 3
            pub const SingleFrameSelection = enum(u32) {
                FirstFrame = 0x0,
                LastFrame = 0x1,
                SpecificFrame = 0x2
            };
            // Alignment: 4
            // Member count: 4
            pub const SmartPropColorSelectionMode_t = enum(u32) {
                SPECIFIC_COLOR = 0x0,
                GRADIENT_RANDOM = 0x1,
            ...
            // Alignment: 4
            // Member count: 2
            pub const SmartPropGridPlacementMode_t = enum(u32) {
                SEGMENT = 0x0,
                FILL = 0x1
            };
            // Alignment: 4
            // Member count: 2
            pub const RemapValueType = enum(u32) {
                FloatParameter = 0x0,
                VectorParameter = 0x1
            };
            // Alignment: 4
            // Member count: 4
            pub const ScaleMode_t = enum(u32) {
                NONE = 0x0,
            ...
            // Alignment: 4
            // Member count: 4
            pub const TraceNoHitResult_t = enum(u32) {
                NOTHING = 0x0,
                DISCARD = 0x1,
                MOVE_TO_START = 0x2,
                MOVE_TO_END = 0x3
            ...
            // Alignment: 4
            // Member count: 3
            pub const SelectionSource_t = enum(u32) {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StopAtGoalNode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ComponentState = struct {
            };
            // Parent: None
            // Field count: 0
            //
            ...
            // MGetKV3ClassDefaults
            // MVDataNodeTintColor
            pub const CSmartPropTransformOperation = struct {
            };
            // Parent: None
            // Field count: 5
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SequenceNode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimScriptComponent = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_ChoiceWeight = struct {
            ...
            pub const CFootLockItem = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CRemapValueItem = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CSmartPropOperation_Trace = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SaveScale = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PlaceInSphere = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StanceScaleNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            pub const CSmartPropAttributeChoiceSelectionMode = struct {
            };
            // Parent: None
            // Field count: 7
            //
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_CreateLocator = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_EdgeAngleCriteria = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeGridOriginMode = struct {
            };
            // Parent: None
            // Field count: 3
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ContainerNodeBase = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_String = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_NodeList = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_Layout2DGrid = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_MotionItem = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_ScaleMode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_MaterialGroup = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_DirectPlaybackNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_RandomColorTintColor = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FootPinningNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FollowAttachmentNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_RandomRotation = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SolveIKChainNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_IsValid = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FollowTargetNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
                pub const m_boneName: usize = 0x48; // CUtlString
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_Condition = struct {
            };
            // Parent: None
            // Field count: 2
            //
            ...
            // MVDataNodeTintColor
            // MVDataClassGroup
            pub const CSmartPropOperation_RestoreState = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SetPosition = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_ClipDataManager = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_ChoiceSelectionMode = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeGridPlacementMode = struct {
            };
            // Parent: None
            // Field count: 3
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_PathHelperNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FootCycleMetric = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CDampedValueComponent = struct {
            ...
            pub const CSmartPropOperation_RotateTowards = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_ParameterCondition = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SlowDownOnSlopesNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_NodeBlend2DItem = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimConflictBase = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CSmartPropChoiceOption = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_MaterialOverride = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_GridPlacementMode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_MoverNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimParameterConflict = struct {
            };
            // Parent: None
            // Field count: 0
            //
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeColorSelectionMode = struct {
            };
            // Parent: None
            // Field count: 5
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_Node = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SaveSurfaceNormal = struct {
            ...
            pub const CSmartPropVariable = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_BlendNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_JiggleBoneNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_LeanMatrixNode = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_VertexCountCriteria = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ResetScale = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FootLockNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeDistributionMode = struct {
            };
            // Parent: None
            // Field count: 2
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CRemapValueComponent = struct {
                pub const m_name: usize = 0x38; // CUtlString
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_EmitTagAction = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLookComponent = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_PathMotor = struct {
            };
            // Parent: None
            // Field count: 1
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_TagManager = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StateTransition = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeRadiusPlacementMode = struct {
            };
            // Parent: None
            // Field count: 4
            //
            ...
            // MPropertyFriendlyName
            // MPropertyElementNameFn
            pub const CFootStepTriggerItem = struct {
                pub const m_footName: usize = 0x0; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StateMachine = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TwoBoneIKNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_MotionItemGroup = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ComponentStateTransition = struct {
            };
            // Parent: None
            // Field count: 1
            //
            ...
            // MVDataClassGroup
            // MVDataOutlinerNameExpr
            pub const CSmartPropOperation_SetVariable = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_DistributionMode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_InputStreamNode = struct {
            };
            // Parent: None
            // Field count: 1
            //
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_Scale = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SetTintColor = struct {
                pub const m_SelectionMode: usize = 0x50; // CSmartPropAttributeChoiceSelectionMode
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_RigidBodyWeightList = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_ChoreoNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            };
            // Parent: None
            // Field count: 1
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_RootNode = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_ApplyColorMode = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SaveColor = struct {
                pub const m_VariableName: usize = 0x50; // CUtlString
            };
            // Parent: None
            // Field count: 11
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FootAdjustmentNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_DampedPathMotor = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyElementNameFn
            pub const CJiggleBoneItem = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SetMateraialGroupChoice = struct {
                pub const m_VariableName: usize = 0x50; // CUtlString
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropFilter_VariableValue = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeApplyColorMode = struct {
            };
            // Parent: None
            // Field count: 7
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CSlopeComponent = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SaveDirection = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StateMachineNode = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_GridOriginMode = struct {
            ...
            pub const CSmartPropElement_Model = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_MaterialCriteria = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_CommentNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Angles = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeOrientationMode = struct {
            };
            // Parent: None
            // Field count: 0
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CSmartPropOperation = struct {
            };
            // Parent: None
            // Field count: 5
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CRagdollComponent = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropVariable_Model = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_EndCap = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ComputeProjectVector3D = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeScaleMode = struct {
            };
            // Parent: None
            // Field count: 1
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_StateList = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ExpressionAction = struct {
                pub const m_paramName: usize = 0x28; // CUtlString
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropFilter_Expression = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ComputeDotProduct3D = struct {
                pub const m_OutputVariableName: usize = 0x50; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Bool = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_CycleControlClipNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Vector2D = struct {
            ...
            pub const CSmartPropOperation_RigidDeformation = struct {
            };
            // Parent: None
            // Field count: 1
            //
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_Group = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_State = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CDemoSettingsComponent = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_MotionParameterManager = struct {
            ...
            // MPropertyDescription
            // MVDataOutlinerAssetNameExpr
            pub const CSmartPropElement_SmartProp = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SpeedScaleNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
                pub const m_paramName: usize = 0x48; // CUtlString
                pub const m_param: usize = 0x50; // AnimParamID
            };
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_GroupNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Vector4D = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_AimCameraNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropFilter_Probability = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_PathMotorBase = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ProxyNodeBase = struct {
            ...
            // MGetKV3ClassDefaults
            // MVDataNodeType
            pub const CSmartPropParameter = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FootStepTriggerNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ConditionContainer = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_ChoiceNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TagCondition = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_TraceNoHit = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const ColorChoice_t = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ComponentManager = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeDirection = struct {
            };
            // Parent: None
            // Field count: 3
            //
            ...
            // MPropertyFriendlyName
            // MVDataOutlinerNameExpr
            pub const CSmartPropChoice = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const MaterialGroupChoice_t = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FootPositionMetric = struct {
                pub const m_feet: usize = 0x28; // CUtlVector<CUtlString>
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TimeCondition = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_Translate = struct {
                pub const m_vPosition: usize = 0x50; // CSmartPropAttributeVector
                pub const m_CoordinateSpace: usize = 0x90; // CSmartPropAttributeCoordinateSpace
            };
            // Parent: None
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StateStatusCondition = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_Graph = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FutureFacingMetric = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_LinearLength = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CRigidBodyWeight = struct {
                pub const m_name: usize = 0x0; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_BoneVelocityMetric = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ComputeDistance3D = struct {
                pub const m_OutputVariableName: usize = 0x50; // CUtlString
                pub const m_OutputCoordinateSpace: usize = 0x58; // CSmartPropAttributeCoordinateSpace
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_BonePositionMetric = struct {
                pub const m_boneName: usize = 0x28; // CUtlString
            };
            // Parent: None
            // Field count: 1
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_AimCameraNode_PropJoint = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_MotionNodeManager = struct {
            };
            // Parent: None
            // Field count: 0
            pub const CSmartPropElement_Deformer = struct {
            };
            // Parent: None
            // Field count: 2
            //
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PlaceOnMesh = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_DistanceRemainingMetric = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_OrCondition = struct {
            };
            // Parent: None
            // Field count: 0
            //
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeTraceNoHit = struct {
            };
            // Parent: None
            // Field count: 1
            //
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_OrientationMode = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyElementNameFn
            pub const CFootPinningItem = struct {
                pub const m_footName: usize = 0x0; // CUtlString
                pub const m_targetBoneName: usize = 0x8; // CUtlString
                pub const m_ikChainName: usize = 0x10; // CUtlString
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PlaceMultiple = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_MidpointDeformer = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_MotionMatchingNode = struct {
            ...
            pub const CSmartPropElement_ModifyState = struct {
            };
            // Parent: None
            // Field count: 2
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_GraphMotionItem = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_BlockSelectionMetric = struct {
            };
            // Parent: None
            // Field count: 5
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_CycleControlNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_CreateSizer = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TargetWarpNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLODComponent = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ComputeCrossProduct3D = struct {
                pub const m_OutputVariableName: usize = 0x50; // CUtlString
                pub const m_InputVectorA: usize = 0x58; // CSmartPropAttributeVector
                pub const m_InputVectorB: usize = 0x98; // CSmartPropAttributeVector
            };
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_NodeConnection = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SetOrientation = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_DirectionVector = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PickOne = struct {
            ...
            // MGetKV3ClassDefaults
            // MVDataNodeType
            pub const CSmartPropModifier = struct {
            ...
            // MGetKV3ClassDefaults
            // MVDataOutlinerAssetNameExpr
            pub const CSmartPropElement_ModelEntity = struct {
                pub const m_sModelName: usize = 0x88; // CSmartPropAttributeModelName
                pub const m_MaterialGroupName: usize = 0xC8; // CSmartPropAttributeMaterialGroup
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_CreateRotator = struct {
                pub const m_Name: usize = 0x50; // CUtlString
                pub const m_vOffset: usize = 0x58; // CSmartPropAttributeVector
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Color = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_CurrentVelocityMetric = struct {
            };
            // Parent: None
            // Field count: 1
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SequenceMotionItem = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimConflictInfo_t = struct {
                pub const m_name: usize = 0x0; // CUtlString
            ...
            // MPropertyFriendlyName
            // MPropertyElementNameFn
            pub const CChoiceNodeChild = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropFilter_MaterialAttributes = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_FitOnLine = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ComputeVectorBetweenPoints3D = struct {
                pub const m_OutputVariableName: usize = 0x50; // CUtlString
                pub const m_OutputCoordinateSpace: usize = 0x58; // CSmartPropAttributeCoordinateSpace
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SubGraphNode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ParamSpan = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_AndCondition = struct {
            };
            // Parent: None
            // Field count: 2
            //
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_SavePosition = struct {
                pub const m_CoordinateSpace: usize = 0x50; // CSmartPropAttributeCoordinateSpace
                pub const m_VariableName: usize = 0x90; // CUtlString
            };
            // Parent: None
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ParameterManager = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PropDynamic = struct {
            };
            // Parent: None
            // Field count: 0
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_GroupInputNode = struct {
            };
            // Parent: None
            // Field count: 5
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_MotionParameter = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_PathMetric = struct {
                pub const m_flDistance: usize = 0x28; // float32
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StanceOverrideNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributeCoordinateSpace = struct {
            };
            // Parent: None
            // Field count: 1
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CStateMachineComponent = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_NodeState = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyElementNameFn
            pub const CConnectionProxyItem = struct {
                pub const m_name: usize = 0x0; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Int = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_ZeroPoseNode = struct {
            };
            // Parent: None
            // Field count: 7
            //
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_BendDeformer = struct {
                pub const m_bDeformationEnabled: usize = 0xA0; // CSmartPropAttributeBool
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_RandomScale = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Float = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ResetRotation = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropFilter_SurfaceAngle = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_Motor = struct {
            ...
            // MGetKV3ClassDefaults
            // MVDataNodeType
            pub const CSmartPropSelectionCriteria = struct {
                pub const m_bEnabled: usize = 0x8; // CSmartPropAttributeBool
            };
            // Parent: None
            // Field count: 8
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_DirectionalBlendNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_PlayerInputMotor = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_StepsRemainingMetric = struct {
                pub const m_feet: usize = 0x28; // CUtlVector<CUtlString>
            ...
            // MVDataClassGroup
            // MVDataExperimentalNodeSet
            pub const CSmartPropOperation_TraceToLine = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_OrientationWarpNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FinishedCondition = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropRoot = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_SetParameterAction = struct {
                pub const m_paramName: usize = 0x28; // CUtlString
                pub const m_param: usize = 0x30; // AnimParamID
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_Rotate = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_LookAtNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_GroupOutputNode = struct {
            };
            // Parent: None
            // Field count: 4
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CFloatAnimValue = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CSmartPropVariable_Vector3D = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PropPhysics = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropVariable_Material = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_JumpHelperNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_RagdollNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FollowPathNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_AimMatrixNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TurnHelperNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_ComputeNormalizedVector3D = struct {
                pub const m_OutputVariableName: usize = 0x50; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SelectorNode = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_RadiusPlacementMode = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_PathPositions = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CPairedSequenceComponent = struct {
            };
            // Parent: None
            // Field count: 0
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_BindPoseNode = struct {
            };
            // Parent: None
            // Field count: 5
            //
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_PathPosition = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TimeRemainingMetric = struct {
            ...
            // MVDataClassGroup
            // MVDataExperimentalNodeSet
            pub const CSmartPropOperation_TraceToPoint = struct {
            ...
            // MVDataNodeTintColor
            // MVDataClassGroup
            pub const CSmartPropOperation_SaveState = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_MaterialTint = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CSmartPropMaterialReplacement = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_WayPointHelperNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SubtractNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_AddNode = struct {
            ...
            pub const CSmartPropElement = struct {
                pub const m_nElementID: usize = 0x8; // int32
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CBlendNodeChild = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CActionComponent = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_Blend2DItem = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_Component = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_Blend2DNode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_TagSpan = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_FutureVelocityMetric = struct {
                pub const m_flDistance: usize = 0x28; // float32
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CDampedValueItem = struct {
            ...
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributePickMode = struct {
            };
            // Parent: None
            // Field count: 0
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimTagConflict = struct {
            };
            // Parent: None
            // Field count: 2
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_ClipData = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_CoordinateSpace = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ConflictManager = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_BoneMaskNode = struct {
                pub const m_weightListName: usize = 0x40; // CUtlString
            ...
            // MPropertyFriendlyName
            // MPropertyElementNameFn
            pub const CAnimGraphDoc_SequenceBlend2DItem = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CTargetSelectorChild = struct {
                pub const m_name: usize = 0x8; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_SingleFrameNode = struct {
                pub const m_sequenceName: usize = 0x50; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_CycleCondition = struct {
                pub const m_comparisonOp: usize = 0x28; // Comparison_t
                pub const m_comparisonString: usize = 0x30; // CUtlString
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_HitReactNode = struct {
                pub const m_inputConnection: usize = 0x40; // CAnimGraphDoc_NodeConnection
            ...
            // MGetKV3ClassDefaults
            // MVDataNodeTintColor
            pub const CSmartPropFilter = struct {
            };
            // Parent: None
            // Field count: 1
            //
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_ColorSelectionMode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_MotionMetric = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropVariable_PickMode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_NodeManager = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_Action = struct {
            };
            // Parent: None
            // Field count: 2
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ToggleComponentAction = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CMovementComponent = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropElement_PlaceOnPath = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_SubGraph = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyElementNameFn
            pub const CSolveIKChainAnimNodeChainData = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_TargetSelectorNode = struct {
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_CurrentRotationVelocityMetric = struct {
            };
            // Parent: None
            // Field count: 0
            //
            // Metadata:
            // MPropertyCustomEditor
            pub const CSmartPropAttributePathPositions = struct {
            };
            // Parent: None
            // Field count: 4
            //
            ...
            // MGetKV3ClassDefaults
            // MPropertyFriendlyName
            pub const CAnimGraphDoc_PairedSequenceNode = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_ParamSpanSample = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_TraceInDirection = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CAnimGraphDoc_NodeStateTransition = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CCPPScriptComponent = struct {
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropFilter_SurfaceProperties = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropVariable_SurfaceProperty = struct {
                pub const m_DefaultValue: usize = 0x38; // CUtlString
            };
            // Parent: None
            // Field count: 3
            ...
            // MPropertyDescription
            // MVDataClassGroup
            pub const CSmartPropOperation_RandomOffset = struct {
            ...
            // MPropertyFriendlyName
            // MPropertyDescription
            pub const CSmartPropSelectionCriteria_TopoEdgeCountCriteria = struct {

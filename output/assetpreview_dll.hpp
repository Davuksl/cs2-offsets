...
namespace cs2_dumper {
    namespace schemas {
        ...
        namespace assetpreview_dll {
            ...
            // Alignment: 4
            // Member count: 4
            enum class LightRigType_t : uint32_t {
                PREVIEW = 0x0,
                THUMBNAIL = 0x1,
            ...
            namespace CLightRigBackground {
                ...
                constexpr std::ptrdiff_t m_Color = 0x1; // Color
            }
            // Parent: None
            // Field count: 3
            //
            ...
            namespace CLightRigExposure {
                constexpr std::ptrdiff_t m_bEnabled = 0x0; // bool
                constexpr std::ptrdiff_t m_flMinEV = 0x4; // float32
                constexpr std::ptrdiff_t m_flMaxEV = 0x8; // float32
            }
            // Parent: None
            // Field count: 1
            //
            ...
            namespace CLightRigSky {
                constexpr std::ptrdiff_t m_hSkyMaterial = 0x0; // CStrongHandle<InfoForResourceTypeIMaterial2>
            }
            // Parent: None
            // Field count: 3
            //
            // Metadata:
            // MGetKV3ClassDefaults
            namespace CLightRigSpotLight {
                constexpr std::ptrdiff_t m_flOuterConeAngle = 0x40; // float32
                constexpr std::ptrdiff_t m_flInnerConeAngle = 0x44; // float32
                constexpr std::ptrdiff_t m_bCastShadows = 0x48; // bool
            }
            // Parent: None
            // Field count: 5
            //
            // Metadata:
            // MGetKV3ClassDefaults
            namespace CLightRigSunLight {
                constexpr std::ptrdiff_t m_flShadowCascadeDistance0 = 0x40; // float32
                constexpr std::ptrdiff_t m_flShadowCascadeDistance1 = 0x44; // float32
                constexpr std::ptrdiff_t m_flShadowCascadeDistance2 = 0x48; // float32
                constexpr std::ptrdiff_t m_flShadowCascadeDistance3 = 0x4C; // float32
                constexpr std::ptrdiff_t m_bCastShadows = 0x50; // bool
            }
            // Parent: None
            // Field count: 1
            //
            ...
            namespace CLightRigPostProcessing {
                constexpr std::ptrdiff_t m_hPostProcessing = 0x0; // CStrongHandle<InfoForResourceTypeCPostProcessingResource>
            }
            // Parent: None
            // Field count: 2
            //
            ...
            namespace CLightRigLight {
                ...
                constexpr std::ptrdiff_t m_vDirection = 0xC; // Vector
                constexpr std::ptrdiff_t m_vLookAt = 0x18; // Vector
                constexpr std::ptrdiff_t m_Color = 0x24; // Color
                constexpr std::ptrdiff_t m_flAxisScale = 0x28; // float32
                constexpr std::ptrdiff_t m_flRadius = 0x2C; // float32
                constexpr std::ptrdiff_t m_flBrightness = 0x30; // float32
                constexpr std::ptrdiff_t m_flLightSourceRadius = 0x34; // float32
                constexpr std::ptrdiff_t m_flDistance = 0x38; // float32
                constexpr std::ptrdiff_t m_bRelativePositioning = 0x3C; // bool
                constexpr std::ptrdiff_t m_bParentToCamera = 0x3D; // bool
            }
            // Parent: None
            // Field count: 3
            //
            ...
            namespace CLightRigVMap {
                constexpr std::ptrdiff_t m_MapName = 0x0; // CResourceNameTyped<CWeakHandle<InfoForResourceTypeVMapResourceData_t>>
                constexpr std::ptrdiff_t m_bRender3DSkybox = 0xE0; // bool
                constexpr std::ptrdiff_t m_bParticlesTraceAgainstMap = 0xE1; // bool
            }
            // Parent: None
            // Field count: 10
            //
            ...
            namespace CToolSceneLightRig {
                constexpr std::ptrdiff_t m_nRigType = 0x8; // LightRigType_t
                constexpr std::ptrdiff_t m_Suns = 0x10; // CUtlVector<CLightRigSunLight>
                constexpr std::ptrdiff_t m_PointLights = 0x28; // CUtlVector<CLightRigPointLight>
                constexpr std::ptrdiff_t m_SpotLights = 0x40; // CUtlVector<CLightRigSpotLight>
                constexpr std::ptrdiff_t m_Background = 0x58; // CLightRigBackground
                constexpr std::ptrdiff_t m_Grid = 0x5D; // CLightRigGrid
                constexpr std::ptrdiff_t m_Exposure = 0x64; // CLightRigExposure
                constexpr std::ptrdiff_t m_PostProcessing = 0x70; // CLightRigPostProcessing
                constexpr std::ptrdiff_t m_Sky = 0x78; // CLightRigSky
                constexpr std::ptrdiff_t m_BackgroundMap = 0x80; // CLightRigVMap
            }
        }
    }
}

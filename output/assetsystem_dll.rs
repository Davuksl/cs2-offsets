...
pub mod cs2_dumper {
    pub mod schemas {
        ...
        pub mod assetsystem_dll {
            ...
            // Member count: 15
            #[repr(u32)]
            pub enum ResourceDataEncodingType_t {
                RESOURCE_ENCODING_INVALID = u32::MAX,
            ...
            // Member count: 3
            #[repr(u32)]
            pub enum AssetWarningFixType_t {
                NONE = 0x0,
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub mod ResourceBlockTypeInfo_t {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub mod CResourceAssetTypeInfo {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub mod AutoTagVDataCondition_t {

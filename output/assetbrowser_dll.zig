...
pub const cs2_dumper = struct {
    pub const schemas = struct {
        ...
        // Class count: 66
        // Enum count: 18
        pub const assetbrowser_dll = struct {
            // Alignment: 4
            // Member count: 2
            ...
            // Alignment: 4
            // Member count: 2
            pub const GraphCanvasItemHoverBehavior_t = enum(u32) {
                HOVER_PROPAGATE = 0x0,
                HOVER_STOP_PROPAGATION = 0x1
            };
            // Alignment: 4
            // Member count: 9
            pub const GraphCanvasInteractionPriority_t = enum(u32) {
                NONINTERACTIVE = 0xFFFFD8F1,
                GROUP = 0x0,
                BASE = 0x1,
                DRAG_HANDLE = 0x2,
                RESIZE_EDGE = 0x3,
            ...
            // Alignment: 4
            // Member count: 5
            pub const GraphCanvasChildLayoutAlgorithm_t = enum(u32) {
                DEFAULT = 0x0,
                VBOX = 0x1,
                VBOX_REVERSE = 0x2,
                HBOX = 0x3,
            ...
            // Alignment: 4
            // Member count: 5
            pub const GraphCanvasBackgroundPosition_t = enum(u32) {
                Top = 0x0,
                Center = 0x1,
                Bottom = 0x2
            };
            // Alignment: 4
            // Member count: 4
            pub const GraphCanvasTextClipMode_t = enum(u32) {
                EXPAND_ITEM = 0x0,
                CLIP_TEXT = 0x1,
                ELIDE_TEXT_END = 0x2,
                WORD_WRAP = 0x3
            ...
            // Alignment: 4
            // Member count: 4
            pub const GraphCanvasBackgroundRepeat_t = enum(u32) {
                Repeat = 0x0,
                NoRepeat = 0x1,
                RepeatX = 0x2,
                RepeatY = 0x3
            ...
            // Alignment: 4
            // Member count: 4
            pub const GraphCanvasBackgroundImageSize_t = enum(u32) {
                Natural = 0x0,
                Contain = 0x1,
                Cover = 0x2,
                Stretch = 0x3
            ...
            // Alignment: 4
            // Member count: 2
            pub const LayoutAxis_t = enum(u32) {
                X = 0x0,
                Y = 0x1
            };
            // Alignment: 4
            // Member count: 3
            pub const GraphCanvasBorderDrawBehavior_t = enum(u32) {
                Centered = 0x0,
                Inside = 0x1,
                Outside = 0x2
            };
            // Alignment: 4
            // Member count: 4
            pub const GraphCanvasVAlign_t = enum(u32) {
                TOP = 0x0,
                CENTER = 0x1,
                BOTTOM = 0x2,
                STRETCH = 0x3
            ...
            // Alignment: 4
            // Member count: 3
            pub const GraphCanvasVisibilityState_t = enum(u32) {
                VISIBLE = 0x0,
                HIDDEN = 0x1,
                COLLAPSE = 0x2
            };
            // Alignment: 4
            // Member count: 4
            pub const GraphCanvasPositioning_t = enum(u32) {
                AUTO = 0x0,
                INSIDE_PARENT = 0x1,
                OUTSIDE_PARENT = 0x2,
            ...
            // Alignment: 4
            // Member count: 13
            pub const GraphCanvasRenderLayer_t = enum(u32) {
                INVALID = 0xFFFFFFFF,
                COMMENTS = 0x0,
            ...
            // Alignment: 4
            // Member count: 13
            pub const GraphCanvasPseudoClass_t = enum(u32) {
                INVALID = 0x0,
                FIRST_CHILD = 0x1,
                LAST_CHILD = 0x2,
                NTH_CHILD = 0x3,
            ...
            // Alignment: 4
            // Member count: 4
            pub const GraphCanvasHAlign_t = enum(u32) {
                LEFT = 0x0,
                CENTER = 0x1,
                RIGHT = 0x2,
                STRETCH = 0x3

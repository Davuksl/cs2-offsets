...
pub const cs2_dumper = struct {
    pub const schemas = struct {
        ...
        // Class count: 101
        // Enum count: 4
        pub const assetpreview_dll = struct {
            // Alignment: 4
            // Member count: 2
            ...
            // Alignment: 4
            // Member count: 4
            pub const LightRigType_t = enum(u32) {
                PREVIEW = 0x0,
                THUMBNAIL = 0x1,
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigBackground = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigExposure = struct {
                pub const m_bEnabled: usize = 0x0; // bool
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigSpotLight = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigSunLight = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigPostProcessing = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigGrid = struct {
                pub const m_bEnabled: usize = 0x0; // bool
                pub const m_Color: usize = 0x1; // Color
            };
            // Parent: None
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigPointLight = struct {
            };
            // Parent: None
            // Field count: 11
            //
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigLight = struct {
            ...
            // Metadata:
            // MGetKV3ClassDefaults
            pub const CLightRigVMap = struct {
            ...
            pub const CToolSceneLightRig = struct {
